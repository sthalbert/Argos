...
*/}}
{{- define "argos-ingest-gw.fullname" -}}
...
*/}}
{{- define "argos-ingest-gw.labels" -}}
helm.sh/chart: {{ include "argos-ingest-gw.chart" . }}
{{ include "argos-ingest-gw.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
{{- define "argos-ingest-gw.selectorLabels" -}}
app.kubernetes.io/name: {{ include "argos-ingest-gw.name" . }}
app.kubernetes.io/instance: {{ .Release.Name }}
{{- end }}

{{- define "argos-ingest-gw.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "argos-ingest-gw.fullname" .) .Values.serviceAccount.name }}
{{- else }}
{{- default "default" .Values.serviceAccount.name }}
{{- end }}
{{- end }}

{{- define "argos-ingest-gw.image" -}}
...
*/}}
{{- define "argos-ingest-gw.mtlsMountPath" -}}
...
*/}}
{{- define "argos-ingest-gw.vaultAnnotations" -}}
...
vault.hashicorp.com/agent-inject-template-tls.crt: |
  {{`{{ with secret "`}}{{ .Values.mtls.vault.pkiMount }}/issue/{{ .Values.mtls.vault.pkiRole }}{{`" "common_name=`}}{{ include "argos-ingest-gw.fullname" . }}{{`" "ttl=`}}{{ .Values.mtls.vault.certTTL }}{{`" -}}
  {{ .Data.certificate }}
  {{- end }}`}}
...
vault.hashicorp.com/secret-volume-path: {{ include "argos-ingest-gw.mtlsMountPath" . | quote }}
{{- end }}
{{- end }}
